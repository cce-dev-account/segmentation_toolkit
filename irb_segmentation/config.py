...
class LoggingConfig:
    ...
    log_format: Optional[str] = None  # Custom log format string
    ...
    def validate(self) -> List[str]:
        ...
        if self.level.upper() not in valid_levels:
            issues.append(f"Invalid log level '{self.level}'. Valid levels: {valid_levels}")
...
class SegmentationConfig:
    ...
    def validate(self) -> List[str]:
        ...
        if self.logging is not None:
            issues.extend(self.logging.validate())
    ...
    def summary(self) -> str:
        ...
        if self.logging is not None:
            lines.extend([
                ...
                f"  Log file: {self.logging.log_file or 'None (console only)'}",
                f"  Custom format: {self.logging.log_format or 'Default'}",
            ])
